...
**DocHarvester** is a Python-powered tool designed to automate and accelerate the process of finding and organizing critical project documents. Its main use was for engineering and environmental projects, but is flexible enough for any scenario requiring fast, reliable document retrieval across large, complex directory structures.
